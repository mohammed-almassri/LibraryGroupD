    ...
    public void addTestCheckouts() {
        ...
        if (member1 != null && book1 != null && book1.getCopies().length > 0) {
            ...
            if (copy1 != null) {
                ...
                da.updateBook(book1.getIsbn(), book1);
                System.out
                        .println("Overdue checkout added for member " + member1.getMemberId() + " and book "
                                + book1.getIsbn());
            }
        }
        ...
        if (member2 != null && book2 != null && book2.getCopies().length > 0) {
            ...
            if (copy2 != null) {
                ...
                da.updateBook(book2.getIsbn(), book2);
                System.out
                        .println("Checkout added for member " + member2.getMemberId() + " and book " + book2.getIsbn());
            }
        }
    }
